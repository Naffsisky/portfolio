...
function Cv() {
  const buttonDownload = () => {
    fetch("https://s3.nevaobjects.id/data-collection/Prinafsika-resume.pdf")
      .then((response) => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-between lg:p-24 p-6 bg-zinc-900 lg:ml-64">
      ...
      <iframe src="https://s3.nevaobjects.id/data-collection/Prinafsika-resume.pdf" className="w-full h-[60vh] lg:h-[80vh] rounded-xl border border-purple-500" allowFullScreen title="Resume"></iframe>
      <div className="pt-5">

  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-between lg:p-24 p-7 bg-zinc-900 lg:ml-64">
      ...
      <section className="flex gap-5">
        <div className="border-1 border-red-500 bg-black rounded-xl">
        ...
        <br />
        <div className="border-1 border-indigo-500 bg-black rounded-xl">
          <p className="text-indigo-500 text-xl pt-5 text-center indigo-running-text">Style</p>
          <div className="gap-2 grid grid-cols-2 sm:grid-cols-4 p-5">
      ...
      <section className="flex gap-5 pt-5">
        <div className="border-1 border-green-500 bg-black rounded-xl">
          <p className="text-white text-xl text-center pt-5 red-running-text">Full Stack</p>
          <div className="gap-2 grid grid-cols-2 sm:grid-cols-4 p-5">
            {fullStack.map((item, index) => (
              <Card shadow="sm" key={index} className="border-1 border-green-500 bg-transparent">
                <CardBody className="overflow-visible p-0">
                  <Image shadow="sm" radius="lg" width="100%" alt={item.title} className="object-fit h-[100px] w-[100px] bg-white" src={item.img} />
                </CardBody>
                <CardFooter className="text-small justify-center">
        ...
        <br />
        <div className="border-1 border-yellow-500 bg-black rounded-xl">
          <p className="text-indigo-500 text-xl pt-5 text-center indigo-running-text">Style</p>
          <div className="gap-2 grid grid-cols-2 sm:grid-cols-4 p-5">
            {styleCss.map((item, index) => (
              <Card shadow="sm" key={index} className="border-1 border-yellow-500 bg-transparent">
                <CardBody className="overflow-visible p-0">
                  <Image shadow="sm" radius="lg" width="100%" alt={item.title} className="object-fit h-[100px] w-[100px] bg-white" src={item.img} />
                </CardBody>
                <CardFooter className="text-small justify-center">

  ...
  return (
    <html lang="en">
      ...
      <body className={inter.className + ' bg-zinc-900'}>
        ...
        <Suspense />
        <Script defer src="http://77.237.246.155:3000/script.js" data-website-id="0a527cde-ce9b-4f48-92e1-05cdc731a19f" strategy="lazyOnload" data-domains="prinafsika.world" />
      </body>
    </html>
  )
}

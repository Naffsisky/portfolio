# Belajar Kubernetes dengan MicroK8s

> Materi ini membahas dasar-dasar Kubernetes menggunakan **MicroK8s**, mulai dari alasan memilih MicroK8s, perbandingan dengan Minikube, instalasi, penggunaan Pod, ReplicaSet, Deployment, Service, LoadBalancer, Ingress, hingga konfigurasi HTTPS menggunakan Let's Encrypt dan cert-manager.
